...
useEffect(() => {
// Create IntersectionObserver for lazy animation
...
const card = entry.target as HTMLDivElement;
        ...
        // GSAP animation when card enters view
        gsap.to(card, {
          opacity: 1,
          y: 0,
          scale: 1,
...
return ( <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 py-10">
