...
export default function Nav() {
  ...
  useEffect(() => {
    if (!mounted || window.innerWidth < 768 || isAdmin) return;
      ...
      <div className="fixed top-0 left-0 w-full pt-5 z-50 hidden md:flex justify-center pointer-events-none">
        ...
        >
          <div className="px-6 flex items-center justify-between">
            ...
            <div
              ref={authRef}
              className="flex-1 flex justify-end gap-5 items-center"
            >
              {loggedIn ? (
                <>
                  <UserIcon
                    className="cursor-pointer hover:text-sky-400 hover:scale-110 transition"
                  ...
                  <LogOut
                    className="cursor-pointer hover:text-red-400 hover:scale-110 transition"
