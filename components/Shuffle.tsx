...
// Map tag names to HTML element types
type TagMap = {
...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  useGSAP(
    () => {
      if (!ref.current || !(children || text) || !fontsLoaded) return;
  ...
  const baseTw =
  "inline-block break-words will-change-transform uppercase text-[3rem] md:text-6xl lg:text-8xl tracking-tight leading-none font-zentry";
